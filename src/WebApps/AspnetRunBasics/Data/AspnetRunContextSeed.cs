...
{
    public async static Task SeedAsync(AspnetRunContext aspnetrunContext, ILoggerFactory loggerFactory, int? retry = 0)
    {
        ...
        catch (Exception exception)
        {
            if (retryForAvailability < 10)
            {
                ...
                ILogger<AspnetRunContextSeed> log = loggerFactory.CreateLogger<AspnetRunContextSeed>();
